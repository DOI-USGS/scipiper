...
```{r delete_all}
non_group_targets <- tail(list_all_targets('task_plan_1.yml'), -1L) # the first target is the group target `task_plan_1`
scdel(target_names=non_group_targets, remake_file='task_plan_1.yml')
```
